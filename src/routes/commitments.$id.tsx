...
function CommitmentDetails() {
  ...
  return (
    <Shell>
      <DetailHeader commitment={commitment} />
      <main className="mx-auto grid max-w-6xl gap-12 px-5 py-10 sm:px-8 sm:py-14 lg:grid-cols-[1fr_340px] lg:gap-16">
        <div className="space-y-10">
          ...
          <EvidencePanel commitment={commitment} />
        ...
        <aside className="space-y-8">
          ...
          <section>
            <div className="flex items-center justify-between">
              ...
              <span className="font-mono text-[10px] text-faint">Base · mock</span>
            </div>
            <div className="mt-3 border-y border-rule">
              <TransactionRow label="Funds locked" hash={commitment.transactionHash} />
              {commitment.releaseHash && (
                <TransactionRow label="Funds released" hash={commitment.releaseHash} />
              )}
            </div>
          </section>
          <section className="border border-rule bg-panel p-5">
            ...
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
              {commitment.status === "active"
                ? "Review the verified evidence and preview how this commitment resolves."
