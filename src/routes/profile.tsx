...
import { ArrowLeft, ArrowUpRight, Check, CircleX, Clock3 } from "lucide-react";
...
import { commitments, profileHistory } from "@/services/mockData";
    ...
    <Shell>
      <main className="mx-auto max-w-6xl px-5 py-10 sm:px-8 sm:py-14">
        ...
        <section className="mt-10 grid gap-10 border-b border-rule pb-12 lg:grid-cols-[1fr_360px] lg:items-end">
          <div>
            <SectionEyebrow>Public project profile</SectionEyebrow>
          ...
          <div className="border-l-2 border-lime pl-5">
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              2 of 3 resolved commitments delivered
            </p>
          </div>
        </section>
        <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-5">
          <StatCard label="Total" value="04" />
          <StatCard label="Completed" value="02" tone="accent" />
          <StatCard label="Active" value="01" />
          <StatCard label="Failed" value="01" tone="danger" />
          <StatCard label="Value committed" value="$22k" detail="lifetime" />
        </div>
            ...
            {profileHistory.map((commitment) => (
              ...
              >
                ...
                <div className="sm:text-right">
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">{commitment.deadlineShort}</p>
                </div>
                <Link
                  to="/commitments/$id"
        ...
        <section className="mt-14 border-t border-rule pt-10">
          <div className="grid gap-6 sm:grid-cols-3">
            {[
              { label: "Delivered", value: "2", Icon: Check },
              { label: "In progress", value: "1", Icon: Clock3 },
              { label: "Missed", value: "1", Icon: CircleX },
